  ...
  if (embedded) {
    return (
      <main className="min-h-screen bg-[#f3f5ef] p-3 text-[#1e2923] sm:p-6">
        ...
        >
          <div className="mb-7 border-b border-[#e1e6df] pb-6">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#53705e]">
              Service request
            </p>
            <h1 className="mt-3 text-3xl font-semibold tracking-[-0.035em]">
              Tell us about your property.
            </h1>
            <p className="mt-3 leading-7 text-[#5b6860]">
              Share a few details and our team will follow up about availability and next steps.
            </p>
          </div>
          <ContactForm />
        </section>
