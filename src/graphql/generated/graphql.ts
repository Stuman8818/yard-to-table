...
export type ConsultationDetailsQuery = { consultation: { id: string, type: ConsultationType, scheduledStart: string, scheduledEnd: string, status: ConsultationStatus, notes: string | null, createdAt: string, updatedAt: string, lead: { id: string, firstName: string, lastName: string } | null, customer: { id: string, firstName: string, lastName: string } | null, property: { id: string, addressLine1: string, addressLine2: string | null, city: string, state: string, postalCode: string } | null, createdBy: { name: string | null, email: string }, assignedUser: { name: string | null, email: string } | null } | null };
