 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query CustomerDetails($id: ID!) {\n  customer(id: $id) {\n    id\n    firstName\n    lastName\n    email\n    phone\n    createdAt\n    organization {\n      name\n    }\n    sourceLead {\n      id\n    }\n    properties {\n      id\n      addressLine1\n      addressLine2\n      city\n      state\n      postalCode\n      accessNotes\n      createdAt\n    }\n  }\n}"): (typeof documents)["query CustomerDetails($id: ID!) {\n  customer(id: $id) {\n    id\n    firstName\n    lastName\n    email\n    phone\n    createdAt\n    organization {\n      name\n    }\n    sourceLead {\n      id\n    }\n    properties {\n      id\n      addressLine1\n      addressLine2\n      city\n      state\n      postalCode\n      accessNotes\n      createdAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
